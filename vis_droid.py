...
if __name__ == "__main__":
    ...
    length = MH_Mul['poses'].shape[0]
    for t in range(length):
        droid_MH.track(t, droid_MH.video.images[t], intrinsics=droid_MH.video.intrinsics[t])
        time.sleep(0.5)
        print(t)
