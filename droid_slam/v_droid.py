...
from v_depth_video import V_DepthVideo
from v_motion_filter import V_MotionFilter
from v_droid_frontend import V_DroidFrontend
from v_droid_backend import V_DroidBackend
...
class VDroid:
    def __init__(self, args):
        ...
        self.video = V_DepthVideo(args.image_size, args.buffer, stereo=args.stereo)

        # filter incoming frames so that there is enough motion
        self.filterx = V_MotionFilter(self.net, self.video, thresh=args.filter_thresh)

        # frontend process
        self.frontend = V_DroidFrontend(self.net, self.video, self.args)
        
        # backend process
        self.backend = V_DroidBackend(self.net, self.video, self.args)
