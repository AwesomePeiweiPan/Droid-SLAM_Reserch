...
class V_DepthVideo:
    ...
    def reproject(self, ii, jj):
        ...
        ii, jj = V_DepthVideo.format_indicies(ii, jj)
    ...
    def distance(self, ii=None, jj=None, beta=0.3, bidirectional=True):
        ...
        if bidirectional:
            ...
            d1 = v_droid_backend.frame_distance(
                poses, self.disps, self.intrinsics[0], ii, jj, beta)

            d2 = v_droid_backend.frame_distance(
                poses, self.disps, self.intrinsics[0], jj, ii, beta)

            d = .5 * (d1 + d2)

        else:
            d = v_droid_backend.frame_distance(
    ...
    def cuda_ba(self, target, weight, eta, ii, jj, t0=1, t1=None, itrs=2, lm=1e-4, ep=0.1, motion_only=False):
        ...
        with self.get_lock():
            ...
            v_droid_backend.ba(self.poses, self.disps, self.intrinsics[0], self.disps_sens,
